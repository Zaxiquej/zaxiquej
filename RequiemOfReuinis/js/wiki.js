...
const UI_TEXT={zh:{pagination:'分页',previousPage:'上一页',nextPage:'下一页',pageNumber:'页码',beforeUpgrade:'升级前',afterUpgrade:'升级后'},en:{pagination:'Pagination',previousPage:'Previous',nextPage:'Next',pageNumber:'Page',beforeUpgrade:'Before Upgrade',afterUpgrade:'After Upgrade'},ja:{pagination:'ページ切り替え',previousPage:'前へ',nextPage:'次へ',pageNumber:'ページ',beforeUpgrade:'強化前',afterUpgrade:'強化後'}};
