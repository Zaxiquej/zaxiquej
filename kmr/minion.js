const minions = [
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 48, name: 'lqyy', effect: '每22s，从一个有3张龙之启示，总计40张卡的卡组中抽5张牌。根据抽到的龙之启示数量获得增益：<br><span style="font-size: smaller;">1张：获得[kmr单次受到的最高伤害]/2的金币；<br>2张：改为获得[kmr单次受到的最高伤害]*4的金币；<br>3张：还会使升级消耗金币永久降低10%（叠乘）；<br>3张恰为前3张：还会使下次转生时，额外获得2以太。</span>' }
        ]
    }
];
