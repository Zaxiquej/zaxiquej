const minions = [
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 33, name: '无尽连击', effect: '每当任何助战攻击，该助战获得等同于成长50%的临时攻击力。每30s，失去这些临时攻击力，但是有5%概率将其的10%转化为永久攻击力，且每50级提升1%概率（上限25%，转化不视为增加攻击力）。' }
        ]
    },
    {
        name: '一只小飘飘',
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 44, name: '魔咒', effect: '每48s，使你下一次攻击不再判定[打个教先]，而是改为额外造成[本局游戏[打个教先]最高连续失败次数^2.5]倍的伤害。' }
        ]
    },
    {
        name: '星导过星导',
    ...
    },
    {
        ...
        supEnhancecost: 4.6,
        skills: [
            { level: 5, name: '知名皇黑', effect: '每当解锁或重抽助战后，接下来的24s内，kmr受到的伤害增加60%。（时间内再次触发改为延长时间）' },
    ...
    },
    {
        ...
        supEnhancecost: 4.8,
        skills: [
            { level: 8, name: '终轮常客', effect: '每40s，在接下来的20s内，攻击时额外造成[100+该助战等级^0.5]%伤害，但是攻击时有2%概率直接失去此状态并永久增加[5*该助战攻击力^0.9]点攻击力。（可叠加）' },
            { level: 45, name: '咲夜的怀表', effect: '攻击后，2%概率使全部当前光环（具有持续时长的效果）持续时长增加2s。如果处于[终轮常客]状态下，则改为增加4s。' }
        ]
    },
    {
        name: '祈雅喵哒',
        ...
        supEnhancecost: 3.2,
        skills: [
            { level: 7, name: '老实猪猪', effect: '介绍中带有🐷的助战升级时，增加的攻击力额外增加[4*(原攻击力位数)]%。' },
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 65, name: '雷维翁之力', effect: '每当一个助战造成直接攻击外的伤害，使其攻击力永久提升[(此伤害^0.8)*0.02]点。' }
        ]
    },
    {
        name: '真白',
    ...
    },
    {
        ...
        supEnhancecost: 5.8,
        skills: [
            { level: 9, name: '虽强但弱', effect: '每当攻击力最高的其他助战提升攻击力，该助战与攻击力最低的其他助战也提升该数值18%的攻击力（至少1点）。' },
    ...
    },
    {
        ...
        supEnhancecost: 4.5,
        skills: [
            { level: 5, name: 'inm剧场', effect: '每40s，获得1点能量。<br>启动：消耗全部能量，在接下来的[能量*6]s内，每当一个助战触发常规音效(10%概率），其会被随机扭曲，且触发者（如果非本助战）与该助战均会获得[0.2*(本次攻击伤害)^0.6]点成长。（时间内再次触发改为延长时间）', active: true },
    ...
    name: '永生的希望',
    id: 49,
    image: 'kmr/image/gui.png',
    voice: 'kmr/voice/gui.mp3',
    description: '你是？重要的🐢，不能忘记的🐢，不能忘记的🐢……',
    baseattack: 20,
    addattack: 16,
    attackSpeed: 4000, // in milliseconds
    basecost: 24,
  ...
  },
  {
    ...
    skills: [
        ...
        { level: 58, name: '杂技之王', effect: '每当你判定概率失败1000次，造成[攻击力*8]点伤害，并使下一个概率低于10%的技能必定触发。每次触发，使倍率增加3。'}
    ]
  },
  {
    name: 'Afezeria',
    ...
    skills: [
        ...
        { level: 54, name: '瞎到暴死', effect: '每当该助战触发成长时，获得1点能量。<br>启动：如果你具有至少10点能量，消耗全部能量。从你的最多5名助战中选择1名，令其攻击直到消耗的时间超过[消耗的能量]s。', active: true }
    ]
  },
  {
    name: '喵鲁汉化组',
