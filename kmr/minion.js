const minions = [
    ...
    },
    {
        ...
        supEnhancecost: 4.5,
        skills: [
            { level: 5, name: 'inm剧场', effect: '每48s，获得1点能量。<br>启动：消耗全部能量，在接下来的[能量*6]s内，每当一个助战触发常规音效(10%概率），其会被随机扭曲，且触发者（如果非本助战）与该助战均会获得[0.2*(本次攻击伤害)^0.6]点成长。（时间内再次触发改为延长时间）', active: true },
