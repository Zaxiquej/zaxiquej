const minions = [
    ...
    },
    {
        ...
        supEnhancecost: 5,
        skills: [
            { level: 6, name: '虫虫咬他', effect: '升级该角色后，永久提升1点成长。' },
    ...
    },
    {
        ...
        supEnhancecost: 4.2,
        skills: [
            { level: 10, name: '小猪存钱罐', effect: '降低25%解锁助战与重抽助战需要的金币。' },
            { level: 36, name: '日一皇', effect: '当你升级助战后，如果你的助战等级之和变为100的倍数，使全部助战攻击力增加[等级之和/5]点攻击力。' }
        ]
    },
    {
        name: '蕾米莉亚',
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 46, name: '卓绝的契约', effect: '每局游戏仅限一次，主动或一键将一个助战升到2级时，如果你的助战数为7以上，使其攻击速度永久减少20%，升级时攻击力增加量变为原本的^2，并且攻击力永久增加[该助战的攻击力]的数值。' }
        ]
    },
    {
        name: '龙魂仓鼠',
    ...
    },
    {
        ...
        supEnhancecost: 4.8,
        skills: [
            { level: 8, name: '终轮常客', effect: '每40s，在接下来的20s内，攻击时额外造成[100+该助战等级^0.5]%伤害，但是攻击时有2%概率直接失去此状态并永久增加[该助战攻击力^0.9]点攻击力。（可叠加）' },
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 123, name: '红娘', effect: '每局游戏仅限一次，下2个你手动升级的助战将结婚。结婚的助战其中一方由于升级增加攻击力时，另一方也会提升等量攻击力。' }
        ]
    },
    {
        name: '千代田桃',
