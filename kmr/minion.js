const minions = [
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 22, name: '魔咒', effect: '每48s，使你下一次攻击不再判定[打个教先]，而是改为额外造成[本局游戏[打个教先]最高连续失败次数^2.5]倍的伤害。（目前最高连续失败次数为0）。' }
        ]
    },
    {
        name: '星导过星导',
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 18, name: '人偶使', effect: '攻击时，8%概率令1个随机其他助战攻击，触发3次，伤害视为该助战造成。如果正处于[偶像]的状态中，每有一层则额外增加3次。' }
        ]
    },
    {
        name: '热乎闹闹',
