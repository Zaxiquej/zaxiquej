const minions = [
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 13, name: '运气不如他们', effect: '其他助战成功触发一个概率低于20%的技能后，该助战永久获得[等级/12]攻击力（最低为2）。' }
        ]
    },
    {
        name: '昨日之俗',
    ...
    },
    {
        ...
        skills: [
            ...
            { level: 21, name: '重返赛场', effect: '所有其他概率触发的技能如果触发失败，10%概率重新判定一次，不会重复发动。（每25级提升1%概率，最高50%）' }
        ]
    },
    {
        name: '阿万音铃羽',
        ...
        supEnhancecost: 3.6,
        skills: [
            { level: 6, name: '光速上分', effect: '其他助战升级时，15%概率令其与自己直接攻击2次。（每20级，追加1次攻击，上限20次）' },
