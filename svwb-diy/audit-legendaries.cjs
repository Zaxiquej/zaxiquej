...
const modules=[
 ['resurrection',/【谢幕曲】[^\n]*召唤1个『[^』]+』。对自己的主战者造成|【谢幕曲】【土之秘术 \d+】召唤/,'可持续自我复活独立模块：自伤、唤灵、土之秘术三类代价；最终身材与保留能力重新计价，不移除复活者的谢幕曲'],
 ['fairyTribe',/妖精·随从/,'妖精种族供给、强化、进化、计数伤害、进场反应接入既有种族组合器'],
 ['collectibleSummon',/召唤\d+个『(?:年幼宝石兽|温厚的树精)』/,'普通可收集随从也可由效果召唤，卡文保持原版；召唤估值不计其入场曲'],
 ...
 ['tripleAttack',/1回合可以攻击3次/,'独立常驻／进化／超进化模块；高费疾驰按总攻击伤害计价'],
