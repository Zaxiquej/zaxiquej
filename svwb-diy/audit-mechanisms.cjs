...
const supported=['奥义','解放奥义','入场曲','谢幕曲','进化时','超进化时','爆能强化','启动','攻击时','交战时','吟唱','守护','突进','疾驰','毁灭','虹吸','潜行','屏障','威慑','灵气','模式','连击','土之秘术','土之印','魔力增幅时','觉醒','唤灵','亡者召还','融合','协作','瞬念召唤'];
const families=[
 ...
 ['牌组整体替换',/牌组.*替换|牌组.*变更|牌组.*变身/,'整副牌组替换已按用户要求关闭；高费牌组随从减费保留']
...
const report={version:require('./engine').VERSION,source:d.source,retrieved:d.retrieved,nonTokenCards:cards.length,
 note:'仅扫描快照的卡文，不等于涵盖后续新卡或所有自然语言机制；已接入指有可组合模块，不等于复现每张官方卡。奥义／解放奥义已按官方奥义槽10／15门槛接入；其他未覆盖条目继续据实标记。',
